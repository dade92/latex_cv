...
%TODO I removed html and css skills because they don't go to newline.. I did not investigate how to better format them
\skills{{ARM Assembly, LateX/1},{C, C++, Bash, Python/2},{MySQL, MongoDB, Docker, Kubernetes/3}, {Javascript, Node.js, Typescript, React/3.5},{Java, Kotlin, Spring Boot, Maven/4.5}}
...
\begin{twenty}
	\twentyitem{2023}{Example of a FE application using Vue}{Javascript,  Vue}{\url{https://github.com/dade92/vue-example}}
	\twentyitem{2023}{Example of a NodeJs application with MongoDB}{Javascript,  Docker, MongoDB}{\url{https://github.com/dade92/node-example}}
	\twentyitem{2023}{Example of a Spring Boot application with other technologies}{Java, Kotlin, Docker, MongoDB}{\url{https://github.com/dade92/spring-example2}}
...
%During my spare time I play guitar and study music. I'm a passionate reader and I chess palyer. About sports, I like trekking, mountain bike and kayaking.\newline
