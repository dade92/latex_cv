...
%	 EXPERIENCE
%----------------------------------------------------------------------------------------
%TODO:section experience is equal to University projects, copy and paste it!
...
During my experience in Lastminute, I' ve grown in a complete "Agile environment", using scrum method and practices like \emph{Test Driven Development} and \emph{pair programming}.
Moreover, I've used Continuous Integration tools like \emph{Jenkins} and orchestrator like \emph{Kubernetes}.\newline
