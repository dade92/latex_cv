...
\skills{{ARM Assembly/2},{Python, SQL/3},{Html,CSS, Javascript, React/4},{C,C++,Latex/4.5},{Java,Spring Framework,Maven,Kotlin/5}}
...
During my experience in Lastminute, I' ve grown in a complete "Agile environment", using scrum method and practices like \emph{Test Driven Development} and pair programming, I've used Continuous Integration tools like \emph{Jenkins} and orchestrator like \emph{Kubernetes}.\newline
