...
During my professional experience, I' ve grown in a complete "Agile environment", using scrum methods like kanban or sprint and practices like Test Driven Development and pair programming. \newline 
...
\begin{twenty}
	...
	\twentyitem{2021}{Example of a Spring Boot application with CI integration}{Java, Kotlin, Docker, MySQL}{\url{https://github.com/dade92/spring-example1}}
